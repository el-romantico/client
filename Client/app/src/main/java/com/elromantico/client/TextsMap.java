...
public class TextsMap {
    ...
    static {
        dishwashingMap.put(0, "\"Something something make me a sandwitch\" - Men");
        dishwashingMap.put(1, "Now you’re thinking about that greasy lasagna you had earlier, aren’t you?");
        dishwashingMap.put(2, "There's vomit on his sweater already: mom's spaghetti - The real Slim Shady");
        textsMap.put(0, dishwashingMap);

        teethMap.put(0, "\"You gotta do what you gotta do\" - Everyone you know");
        teethMap.put(1, "\"And remember to floss\" - Your dentist probably.");
        textsMap.put(1, teethMap);

        vinylMap.put(0, "\"It’s hard to be a DJ\" - Avicii");
        vinylMap.put(1, "\"Wub-wub-dub dum-dub-dub-wub\" - Skrillex");
        vinylMap.put(2, "The faster you spin it, the screechier it gets");
        vinylMap.put(3, "\"Free-styler, wacka-macka four\" - Everyone, except Bomfunk MC’s");
        textsMap.put(2, vinylMap);

        swordMap.put(0, "Your fingers may be bleeding but at least your game is on edge");
        swordMap.put(1, "\"Do I look cool doing this?\" - Nobody that played this game");
        swordMap.put(2, "Look at you, so fun and edgy!");
        swordMap.put(3, "Does this remind you of that time when… forget it.");
        swordMap.put(4, "\"Your mom does it better\" - Everyone");
        ...
        handbellMap.put(2, "\"Shame. Shame. Shame.\" - Some TV show probably");
